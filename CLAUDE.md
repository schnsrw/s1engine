...
### Current Phase: Production Editor — WASM API Complete (P.1-P.5), Demo Rewrite In Progress (P.7)
### Status: s1-model (72), s1-ops (48), s1-format-txt (41), s1-format-docx (201), s1-format-odt (119), s1-format-md (32), s1-format-pdf (23), s1-convert (90), s1-layout (62), s1-text (39), s1engine (120), s1-crdt (182), s1engine-wasm (102), s1engine-c (10), proptests (5). 1,147 total tests.
