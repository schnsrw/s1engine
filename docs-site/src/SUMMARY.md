...
- [WASM / JavaScript API](./api/wasm.md)
- [C FFI API](./api/c-ffi.md)
...
- [Document Model](./architecture/model.md)
- [Operations & CRDT](./architecture/operations.md)
- [Format Crates](./architecture/formats.md)
- [Layout Engine](./architecture/layout.md)

# Contributing

- [Development Setup](./contributing/setup.md)
- [Architecture Rules](./contributing/rules.md)
